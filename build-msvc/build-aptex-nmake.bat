...
echo Building zlib ...
del *.obj
nmake -s -nologo -f mk-zlib.nmake
echo Building libpng ...
del *.obj
nmake -s -nologo -f mk-libpng.nmake
echo Building freetype ...
del *.obj
nmake -s -nologo -f mk-freetype.nmake
echo Building libotf ...
del *.obj
nmake -s -nologo -f mk-libotf.nmake
echo Building libpixman ...
del *.obj
nmake -s -nologo -f mk-libpixman.nmake
...
nmake -s -nologo -f mk-libcairo.nmake
rd /s /q cairo\src
echo Building lsotfea ...
del *.obj
nmake -s -nologo -f mk-lsotfea.nmake
echo Building kpathsea ...
del *.obj
nmake -s -nologo -f mk-kpathsea.nmake
echo Building ptexenc ...
del *.obj
nmake -s -nologo -f mk-ptexenc.nmake
echo Building libdpx ...
del *.obj
nmake -s -nologo -f mk-libdpx.nmake
echo Building libyaml ...
del *.obj
nmake -s -nologo -f mk-libyaml.nmake
echo Building libmd5 ...
del *.obj
nmake -s -nologo -f mk-libmd5.nmake
...
del *.obj
nmake -s -nologo -f mk-aptex.nmake
del *.obj *.lib
