...
makefile.write("\tranlib libcairo-pdf.a\n")
for i in s:
...
makefile.write("test:\n")
makefile.write("\t$(CC) $(LDFLAGS) -I. -I../../texlive/libs/cairo/cairo-src/src -o test test.c libcairo-pdf.a ../libcairo.a ../libpixman.a ../libz.a -lm\n")
makefile.close()
