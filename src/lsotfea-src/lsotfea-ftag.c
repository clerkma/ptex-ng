...
/* Command-line: gperf -D --output-file=lsotfea-ftag.c lsotfea-ftag.gperf  */
...
#line 244 "lsotfea-ftag.gperf"
      {"vpal", "Proportional Alternate Vertical Metrics"},
#line 240 "lsotfea-ftag.gperf"
