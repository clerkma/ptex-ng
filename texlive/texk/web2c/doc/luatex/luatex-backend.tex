...
This library contains variables and functions related to the \PDF\ backend,
except for the \DVI\ backend’s \type {setdviencoding} function.
You can find more details about the expected values to setters in \in
...
\startsubsection[title={\type {setdviencoding}}]

\topicindex{\DVI+fonts}

\libindex{setdviencoding}

This function with argument 1 activates gid encoding for Open Type fonts in the \DVI\ backend.

\startfunctioncall
pdf.setdviencoding(0|1)
\stopfunctioncall
