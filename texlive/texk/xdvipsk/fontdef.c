...
case 138: break;
#ifdef XDVIPSK
case 239: predospecial(dvibyte(), 0, TRUE); break; /* xxx1 */
case 240: predospecial(twobytes(), 0, TRUE); break; /* xxx2 */
case 241: predospecial(threebytes(), 0, TRUE); break; /* xxx3 */
case 242: predospecial(signedquad(), 0, TRUE); break; /* xxx4 */
#else
