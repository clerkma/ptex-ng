...
#else  /* XDVIPSK */
case 239: i = dvibyte(); predospecial(i, 0, FALSE); break;
case 240: i = twobytes(); predospecial(i, 0, FALSE); break;
case 241: i = threebytes(); predospecial(i, 0, FALSE); break;
case 242: i = signedquad(); predospecial(i, 0, FALSE); break;
#endif /* XDVIPSK */
/* font definition */
