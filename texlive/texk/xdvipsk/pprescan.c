...
#else  /* XDVIPSK */
case 239: predospecial((integer)dvibyte(), 1, FALSE); break; /* xxx1 */
case 240: predospecial((integer)twobytes(), 1, FALSE); break; /* xxx2 */
case 241: predospecial(threebytes(), 1, FALSE); break; /* xxx3 */
case 242: predospecial(signedquad(), 1, FALSE); break; /* xxx4 */
#endif /* XDVIPSK */
