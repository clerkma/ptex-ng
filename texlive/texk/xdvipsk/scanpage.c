...
fontfound:  curfnt = cfnt->desc;
         ...
         break;
#ifdef XDVIPSK
case 239: predospecial((integer)dvibyte(), 1, parse_maps); break; /* xxx1 */
case 240: predospecial((integer)twobytes(), 1, parse_maps); break; /* xxx2 */
case 241: predospecial(threebytes(), 1, parse_maps); break; /* xxx3 */
case 242: predospecial(signedquad(), 1, parse_maps); break; /* xxx4 */
#else
